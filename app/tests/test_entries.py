...
class EntryTesting(TestBase):
    ...
    def test_to_create_entry(self):
        ...
        res = tester.post('/API/v1/entries', data=TestBase.create_entry,headers=self.access_header, content_type='application/json')
    ...
    def test_to_create_entry_with_duplicate_data(self):
        """test to create an entry"""
        tester=self.app.test_client(self)
        res = tester.post('/API/v1/entries',data=TestBase.duplicate_entry ,headers=self.access_header, content_type='application/json')
    ...
    def test_duplicate_update(self):
        """test to get a single entry content"""
        tester=self.app.test_client(self)
        response = tester.put('/API/v1/entries/1',data=TestBase.duplicate_update,headers=self.access_header,
                              content_type="application/json")
    ...
    def test_to_update_entry(self):
        """test to get a single entry content"""
        tester=self.app.test_client(self)
        response = tester.put('/API/v1/entries/1',data=TestBase.update_entry,headers=self.access_header,
                              content_type="application/json")
        self.assertEqual(response.status_code, 200)